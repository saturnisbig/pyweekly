...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'weblog_entry', 'featured',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'weblog_entry', 'featured')
    ...
    models = {
        ...
        u'weblog.entry': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['weblog.Category']", 'symmetrical': 'False'}),
